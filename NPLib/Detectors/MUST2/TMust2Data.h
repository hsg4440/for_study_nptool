...
class TMust2Data : public TObject {
   ...
   public:
     ...
     inline void   SetCsIT(const UShort_t& DetNbr, const UShort_t& CristalNbr, const Double_t& Time){   
      ...
      UShort_t   GetMMStripXEDetectorNbr(int i) const {return fMM_StripXE_DetectorNbr[i];}
      UShort_t   GetMMStripXEStripNbr(int i)    const {return fMM_StripXE_StripNbr[i];}
      Double_t   GetMMStripXEEnergy(int i)      const {return fMM_StripXE_Energy[i];}
      // (X,T)
      UShort_t   GetMMStripXTMult()                      const {return fMM_StripXT_DetectorNbr.size();}
      UShort_t   GetMMStripXTDetectorNbr(int i) const {return fMM_StripXT_DetectorNbr[i];}
      UShort_t   GetMMStripXTStripNbr(int i)    const {return fMM_StripXT_StripNbr[i];}
      Double_t   GetMMStripXTTime(int i)        const {return fMM_StripXT_Time[i];}
      // (Y,E)
      UShort_t   GetMMStripYEMult()                      const {return fMM_StripYE_DetectorNbr.size();}
      UShort_t   GetMMStripYEDetectorNbr(int i) const {return fMM_StripYE_DetectorNbr[i];}
      UShort_t   GetMMStripYEStripNbr(int i)    const {return fMM_StripYE_StripNbr[i];}
      Double_t   GetMMStripYEEnergy(int i)      const {return fMM_StripYE_Energy[i];}
      // (Y,T)
      UShort_t   GetMMStripYTMult()                      const {return fMM_StripYT_DetectorNbr.size();}
      UShort_t   GetMMStripYTDetectorNbr(int i) const {return fMM_StripYT_DetectorNbr[i];}
      UShort_t   GetMMStripYTStripNbr(int i)    const {return fMM_StripYT_StripNbr[i];}
      Double_t   GetMMStripYTTime(int i)        const {return fMM_StripYT_Time[i];}

      // SiLi
      //(E)
      UShort_t   GetMMSiLiEMult()                       const {return fMM_SiLiE_DetectorNbr.size();}
      UShort_t   GetMMSiLiEDetectorNbr(int i)  const {return fMM_SiLiE_DetectorNbr[i];}
      UShort_t   GetMMSiLiEPadNbr(int i)       const {return fMM_SiLiE_PadNbr[i];}
      Double_t   GetMMSiLiEEnergy(int i)       const {return fMM_SiLiE_Energy[i];}
      //(T)
      UShort_t   GetMMSiLiTMult()                       const {return fMM_SiLiT_DetectorNbr.size();}
      UShort_t   GetMMSiLiTDetectorNbr(int i)  const {return fMM_SiLiT_DetectorNbr[i];}
      UShort_t   GetMMSiLiTPadNbr(int i)       const {return fMM_SiLiT_PadNbr[i];}
      Double_t   GetMMSiLiTTime(int i)         const {return fMM_SiLiT_Time[i];}

      // CsI 
      //(E)
      UShort_t   GetMMCsIEMult()                        const {return fMM_CsIE_DetectorNbr.size();}
      UShort_t   GetMMCsIEDetectorNbr(int i)   const {return fMM_CsIE_DetectorNbr[i];}
      UShort_t   GetMMCsIECristalNbr(int i)    const {return fMM_CsIE_CristalNbr[i];}
      Double_t   GetMMCsIEEnergy(int i)        const {return fMM_CsIE_Energy[i];}
      //(T)
      UShort_t   GetMMCsITMult()                        const {return fMM_CsIT_DetectorNbr.size();}
      UShort_t   GetMMCsITDetectorNbr(int i)   const {return fMM_CsIT_DetectorNbr[i];}
      UShort_t   GetMMCsITCristalNbr(int i)    const {return fMM_CsIT_CristalNbr[i];}
      Double_t   GetMMCsITTime(int i)          const {return fMM_CsIT_Time[i];}
