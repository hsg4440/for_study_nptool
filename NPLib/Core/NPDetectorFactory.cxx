...
/////////////////////////////////////////////////////////////////////////////////
NPL::DetectorFactory::~DetectorFactory() { m_Instance = 0; }
...
////////////////////////////////////////////////////////////////////////////////
void NPL::DetectorFactory::AddDetector(std::string Token, ClassDetectorFactoryFn fn) { m_Construct[Token] = fn; }

void NPL::DetectorFactory::AddDetectorReader(std::string Token, ClassDetectorReaderFactoryFn fn) {
  m_ConstructReader[Token] = fn;
}
////////////////////////////////////////////////////////////////////////////////
